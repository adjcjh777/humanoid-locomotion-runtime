...
| R007e | M0 | company G1 23DoF MJLab wrapper/controller selection | 23DoF robot cfg + controller candidate | n/a | action/obs shape and controller source locked | MUST | 白天：人工 | TODO | 前置：R007d 已完成；下一步是建立/选择 23DoF MJLab robot cfg、action/obs shape 和 controller source。若没有成熟 23DoF checkpoint，记录 train/convert/defer 决策，不能把 29DoF ONNX 直接升级为 target evidence |
