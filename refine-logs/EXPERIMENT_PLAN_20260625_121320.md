...
> 归档读法：这是 2026-06-25 的历史快照，保留当时的原始计划表述。日常阅读请优先看已通俗化的最新副本 `refine-logs/EXPERIMENT_PLAN.md`，以及对应 timestamp copy `refine-logs/EXPERIMENT_PLAN_20260626_123244.md`。
