...
- ENPIRE / ADAS / AlphaEvolve / DGM 式的 agentic improvement harness，但只允许离线 proposer / evaluator / auditor，不允许进入实时 safety loop。
...
| [ENPIRE](https://arxiv.org/abs/2606.19980) / [NVIDIA page](https://research.nvidia.com/labs/gear/enpire/) | 2026, arXiv / technical report | verified via arXiv / lab page | coding agents 管理 real-world robot policy self-improvement loop | 强相关对照：agentic robot policy improvement harness | V0 不改底层 locomotion policy，不做真机 autonomous deployment |
...
- [x] 机器人 self-improvement 文献多数改低层 policy 或训练流程。ENPIRE、Self-Improving EFMs、MEDAL++、HumanUP、RMA 都应作为近邻/风险/metric 参考，不作为 V0 方法本体。
