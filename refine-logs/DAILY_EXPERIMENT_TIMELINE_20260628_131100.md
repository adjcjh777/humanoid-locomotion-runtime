...
- [x] Mac 已完成：工具链对齐、纯 Python contract tests、Gate C backend-neutral fake restore testbed、RuntimeManager typed command skeleton、leakage boundary tests、A800 handoff 文档和 citation audit。
