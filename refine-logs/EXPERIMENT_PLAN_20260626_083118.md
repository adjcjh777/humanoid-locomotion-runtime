...
- [ ] R007d: company G1 23DoF raw asset compile smoke 完成；记录 MuJoCo compile result、joint count、mesh/source handling。
...
|-----------|------|------|-----------|------|------|
| M0 | A800 single-host automation ready + robot profile lock | R000-R009a | DONE for M0 smoke/handoff；29DoF MJLab reference smoke passed；company G1 23DoF source identified | low | 23DoF project-local asset compile, MJLab wrapper, controller checkpoint and controller smoke are still pending |
