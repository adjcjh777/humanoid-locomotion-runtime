...
- [x] 在 23DoF project-local asset integration、actuator config、controller artifact 和 adapter smoke 锁定前，不启动 Gate C 的 snapshot/restore 或任何 controller-native baseline。
